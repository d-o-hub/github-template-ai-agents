...
save_cached_result() {
    ...
    # Optimization: Use native bash parameter expansion instead of $(dirname "$cache_file")
    # This eliminates subshell and external process fork overhead, which improves performance
    # when processing high-volume caches.
