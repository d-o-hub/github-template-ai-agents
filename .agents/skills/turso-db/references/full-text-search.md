...
Index multiple columns in one FTS index. The index automatically tracks inserts,
 updates, and deletes.
...
|-----------|-------------|----------|
| `default` | Lowercase, punctuation/whitespace split, drops tokens longer than
40 chars | General English text |
...
ngram:      "iPhone"       → ["iP", "iPh", "Ph", "Pho", "ho", "hon", "on", "one"
, "ne"]
```
