...
def test_validate_safe_path_patterns(tmp_path):
    ...
    prefix_patterns = [
        ...
        "auth.json_copy", "token_secret.json", "token.txt", "access_token.json",
        "refresh_token.txt", "auth_token_dev", "session_token_key", "secret_key_prod",
        "api_key_prod", "api_key.json", "private_key.txt", "private-key.txt", "privkey"
    ]
    ...
    additional_suffixes = [
        ...
        "config.env", "prod.env", "secrets.env", "terraform.tfvars", "vars.tfvars.json"
    ]
